...
exports.deleteUser = exports.updateUser = exports.register = exports.getUserById = exports.getUsers = exports.findOrFail = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    if (user === null) {
                        return [2 /*return*/, { code: 404 }];
                    }
                    return [2 /*return*/, { user: user, code: 200 }];
                case 2:
                    e_1 = _a.sent();
...
function register(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, username, email, password, user, hashedPassword, createdUser, e_4;
...
function updateUser(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var id, _a, username, password, code, e_5;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    id = Number(req.params.id);
